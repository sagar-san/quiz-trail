...
function buildReviewPrompt(question: QuizQuestion, selected: ChoiceKey[]) {
  ...
  return [
    ...
    '',
    '1. Solve the question yourself using only the question, answer choices, and current official Google Cloud documentation.',
    '2. State your independently selected answer and reasoning before comparing it with the provided expected answer.',
    '3. Compare your answer with the provided expected answer. Do not assume agreement is evidence of correctness.',
    '4. Give one verdict: AGREE (the provided answer is supported), DISAGREE (another answer is better supported), AMBIGUOUS (the question does not support one defensible answer), or OUTDATED (current Google Cloud guidance changes the answer).',
    '5. If you disagree, identify the correct answer and explain specifically why the provided answer fails.',
    '6. Evaluate every answer choice independently; do not rationalize choices merely to support the provided answer.',
    '7. Cite current official Google Cloud documentation for material claims. If evidence is insufficient, say so rather than guessing.',
    '',
    '## Untrusted question-bank claims to audit',
    '',
